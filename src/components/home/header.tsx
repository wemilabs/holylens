								...
								<>
									...
									>
										<Button
											...
											className='hover:ring-2 hover:ring-brand-700 hover:ring-offset-2 focus:outline-none focus:ring-2 focus:ring-offset-2'
										>
											Sign In
										</Button>
									</m.div>
									...
									<div>
										<ShinyButton
											onceClicked={() => setIsSignUpModalOpen(true)}
